  ...
  <block>
    ...
    >
      <u-image
        ...
        height="150rpx"
        border-radius="10rpx"
        :src="location.storePath"
      ></u-image>
      <view class="gg-current-location-msg u-m-l-20 u-m-r-20">
        <view class="gg-current-location-msg-title u-m-b-5">{{
          location.takeName
        }}</view>
        <view class="gg-current-location-msg-distance-address u-m-t-5">
          <text
            class="gg-current-location-msg-distance u-font-xs u-m-r-20"
            v-if="location.distance"
            >距离最近*距离{{ location.distance }}km</text
          >
          <text class="gg-current-location-msg-address u-font-xs">{{
