...
var install = function install(Vue, vm) {
  // 此处没有使用传入的params参数
  var getPost = function getPost() {var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { id: 1 };return vm.$u.get(postsUrl + "".concat(params.id));};

  // 将各个定义的接口名称，统一放进对象挂载到vm.$u.api(因为vm就是this，也即this.$u.api)下
  vm.$u.api = { getPost: getPost };
};var _default =
